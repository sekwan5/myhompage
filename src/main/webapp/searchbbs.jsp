			...
			%>
				...
				<tbody>
					<%
						...
						ArrayList<Bbs> list2 = bbsDAO.getSearch(request.getParameter("searchField"),
					...
					<tr>
						...
						<%--현재 게시글에 대한 정보 --%>
						<td><a href="view.jsp?bbsID=<%=list2.get(i).getBbsID()%>"><%=list2.get(i).getBbsTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
