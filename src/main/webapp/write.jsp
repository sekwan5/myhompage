      ...
      <div class="container" style="width:100%;">
		<div class="row">
			<form method="post" action="writeAction.jsp" style="width:100%;">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd; width:1280;">
					<thead>
						<tr>
					...
					<th>
					<input style="width:80px;margin-left:88%; " type="submit" class="btn btn-secondary" value="글쓰기">
